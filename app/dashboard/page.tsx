...
import { practiceProducts, researchProducts, type Product } from "@/lib/products";

export const metadata: Metadata = {
  title: "The suite",
  description:
    "Three practices — Sukari, Orbura, Ardum — and two open research projects, Kytos and Lemma. One thing at a time, each.",
        ...
        <Container>
          <header className="mb-12">
            ...
            <p className="mt-4 max-w-md text-lg text-ink-muted">
              Three practices, two research projects. Each one thing at a time.
            </p>
          </header>
          ...
          <section>
            ...
            <div className="grid gap-4 lg:grid-cols-3">
              {practiceProducts.map((p) => (
                <SuiteCard key={p.slug} p={p} />
              ))}
            </div>
          </section>

          <section className="mt-14">
            <h2 className="mb-2 text-xs uppercase tracking-[0.2em] text-ink-dim">
              The bench
            </h2>
...
function SuiteCard({ p }: { p: Product }) {
  return (
    <Link
